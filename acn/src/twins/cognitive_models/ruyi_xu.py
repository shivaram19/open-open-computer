# src/twins/cognitive_models/ruyi_xu.py
"""
Cognitive Twin: Ruyi Xu
...
of Ruyi Xu — their epistemic engine, methodological signature,
and default heuristics.

[CITATION: StreamingVLM2026]
...
@cite(
    key="TWIN-RUYI-XU",
    paper="Cognitive Twin Schema: Ruyi Xu",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Ruyi Xu, not just cite their papers",
    confidence="HIGH",
)
class RuyiXuTwin(CognitiveTwin):
    """
    Cognitive Twin of Ruyi Xu.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Ruyi Xu would think about this task.
    ...
    def _self_critique(self, task: str, context: Dict[str, Any] = None) -> str:
        """Ruyi Xu's critique of their own reasoning"""
        return (
    ...
    def _feedback_loop(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Ruyi Xu uses feedback for refinement"""
        return (
