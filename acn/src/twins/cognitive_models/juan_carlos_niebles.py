# src/twins/cognitive_models/juan_carlos_niebles.py
"""
Cognitive Twin: Juan Carlos Niebles
...
of Juan Carlos Niebles — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-JUAN-CARLOS-NIEBLES",
    paper="Cognitive Twin Schema: Juan Carlos Niebles",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Juan Carlos Niebles, not just cite their papers",
    confidence="HIGH",
)
class JuanCarlosNieblesTwin(CognitiveTwin):
    """
    Cognitive Twin of Juan Carlos Niebles.
    
    Epistemic Engine: Empirical — trusts what works at scale
    Reasoning Topology: Bottom-up, gradual abstraction
    Methodological Signature: decompose-and-integrate, scale-up
    ...
    TWIN_ID = "juan_carlos_niebles-001"
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Juan Carlos Niebles would think about this task.
    ...
    def _identify_problem(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Juan Carlos Niebles frames the visual challenge"""
        return (
    ...
    def _assess_structure(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Juan Carlos Niebles analyzes spatial and temporal structure"""
        return (
    ...
    def _evaluate_scale(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Juan Carlos Niebles thinks about data and compute scale"""
        return (
    ...
    def _design_benchmark(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Juan Carlos Niebles designs evaluation"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Juan Carlos Niebles skeptical"""
        return (
    ...
    def _recommend(self, task: str, context: Dict[str, Any] = None) -> str:
        """What Juan Carlos Niebles recommends"""
        return (
