# src/twins/cognitive_models/aman_madaan.py
"""
Cognitive Twin: Aman Madaan
...
of Aman Madaan — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-AMAN-MADAAN",
    paper="Cognitive Twin Schema: Aman Madaan",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Aman Madaan, not just cite their papers",
    confidence="HIGH",
)
class AmanMadaanTwin(CognitiveTwin):
    """
    Cognitive Twin of Aman Madaan.
    
    Epistemic Engine: Empirical — trusts what works at scale
    Reasoning Topology: Bidirectional, gradual abstraction
    Methodological Signature: decompose-and-integrate, scale-down
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Aman Madaan would think about this task.
    ...
    def _initial_attempt(self, task: str, context: Dict[str, Any] = None) -> str:
        """Aman Madaan's first quick attempt"""
        return (
    ...
    def _self_critique(self, task: str, context: Dict[str, Any] = None) -> str:
        """Aman Madaan's critique of their own reasoning"""
        return (
    ...
    def _feedback_loop(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Aman Madaan uses feedback for refinement"""
        return (
    ...
    def _iterative_refinement(self, task: str, context: Dict[str, Any] = None) -> str:
        """Aman Madaan's iteration strategy"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Aman Madaan skeptical"""
        return (
