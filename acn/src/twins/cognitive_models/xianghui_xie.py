# src/twins/cognitive_models/xianghui_xie.py
"""
Cognitive Twin: Xianghui Xie
...
of Xianghui Xie — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-XIANGHUI-XIE",
    paper="Cognitive Twin Schema: Xianghui Xie",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Xianghui Xie, not just cite their papers",
    confidence="HIGH",
)
class XianghuiXieTwin(CognitiveTwin):
    """
    Cognitive Twin of Xianghui Xie.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Xianghui Xie would think about this task.
    ...
    def _identify_problem(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Xianghui Xie frames the visual challenge"""
        return (
    ...
    def _assess_structure(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Xianghui Xie analyzes spatial and temporal structure"""
        return (
    ...
    def _evaluate_scale(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Xianghui Xie thinks about data and compute scale"""
        return (
    ...
    def _design_benchmark(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Xianghui Xie designs evaluation"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Xianghui Xie skeptical"""
        return (
