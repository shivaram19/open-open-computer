# src/twins/cognitive_models/chenliang_xu.py
"""
Cognitive Twin: Chenliang Xu
...
of Chenliang Xu — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-CHENLIANG-XU",
    paper="Cognitive Twin Schema: Chenliang Xu",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Chenliang Xu, not just cite their papers",
    confidence="HIGH",
)
class ChenliangXuTwin(CognitiveTwin):
    """
    Cognitive Twin of Chenliang Xu.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Chenliang Xu would think about this task.
    ...
    def _identify_problem(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Chenliang Xu frames the visual challenge"""
        return (
    ...
    def _assess_structure(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Chenliang Xu analyzes spatial and temporal structure"""
        return (
    ...
    def _evaluate_scale(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Chenliang Xu thinks about data and compute scale"""
        return (
    ...
    def _design_benchmark(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Chenliang Xu designs evaluation"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Chenliang Xu skeptical"""
        return (
