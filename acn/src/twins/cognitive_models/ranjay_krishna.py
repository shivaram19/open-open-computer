# src/twins/cognitive_models/ranjay_krishna.py
"""
Cognitive Twin: Ranjay Krishna
...
of Ranjay Krishna — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-RANJAY-KRISHNA",
    paper="Cognitive Twin Schema: Ranjay Krishna",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Ranjay Krishna, not just cite their papers",
    confidence="HIGH",
)
class RanjayKrishnaTwin(CognitiveTwin):
    """
    Cognitive Twin of Ranjay Krishna.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Ranjay Krishna would think about this task.
    ...
    def _identify_problem(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Ranjay Krishna frames the visual challenge"""
        return (
    ...
    def _assess_structure(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Ranjay Krishna analyzes spatial and temporal structure"""
        return (
    ...
    def _evaluate_scale(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Ranjay Krishna thinks about data and compute scale"""
        return (
    ...
    def _design_benchmark(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Ranjay Krishna designs evaluation"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Ranjay Krishna skeptical"""
        return (
    ...
    def _recommend(self, task: str, context: Dict[str, Any] = None) -> str:
        """What Ranjay Krishna recommends"""
        return (
