# src/twins/cognitive_models/jiankang_wang.py
"""
Cognitive Twin: Jiankang Wang
...
of Jiankang Wang — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-JIANKANG-WANG",
    paper="Cognitive Twin Schema: Jiankang Wang",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Jiankang Wang, not just cite their papers",
    confidence="HIGH",
)
class JiankangWangTwin(CognitiveTwin):
    """
    Cognitive Twin of Jiankang Wang.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Jiankang Wang would think about this task.
    ...
    def _identify_problem(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Jiankang Wang frames the visual challenge"""
        return (
    ...
    def _assess_structure(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Jiankang Wang analyzes spatial and temporal structure"""
        return (
    ...
    def _evaluate_scale(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Jiankang Wang thinks about data and compute scale"""
        return (
    ...
    def _design_benchmark(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Jiankang Wang designs evaluation"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Jiankang Wang skeptical"""
        return (
