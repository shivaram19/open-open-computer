# src/twins/cognitive_models/shengyuan_ye.py
"""
Cognitive Twin: Shengyuan Ye
...
of Shengyuan Ye — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-SHENGYUAN-YE",
    paper="Cognitive Twin Schema: Shengyuan Ye",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Shengyuan Ye, not just cite their papers",
    confidence="HIGH",
)
class ShengyuanYeTwin(CognitiveTwin):
    """
    Cognitive Twin of Shengyuan Ye.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Shengyuan Ye would think about this task.
    ...
    def _initial_attempt(self, task: str, context: Dict[str, Any] = None) -> str:
        """Shengyuan Ye's first quick attempt"""
        return (
    ...
    def _self_critique(self, task: str, context: Dict[str, Any] = None) -> str:
        """Shengyuan Ye's critique of their own reasoning"""
        return (
    ...
    def _feedback_loop(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Shengyuan Ye uses feedback for refinement"""
        return (
    ...
    def _iterative_refinement(self, task: str, context: Dict[str, Any] = None) -> str:
        """Shengyuan Ye's iteration strategy"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Shengyuan Ye skeptical"""
        return (
