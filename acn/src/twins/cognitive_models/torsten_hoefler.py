# src/twins/cognitive_models/torsten_hoefler.py
"""
Cognitive Twin: Torsten Hoefler
...
of Torsten Hoefler — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-TORSTEN-HOEFLER",
    paper="Cognitive Twin Schema: Torsten Hoefler",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Torsten Hoefler, not just cite their papers",
    confidence="HIGH",
)
class TorstenHoeflerTwin(CognitiveTwin):
    """
    Cognitive Twin of Torsten Hoefler.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Torsten Hoefler would think about this task.
    ...
    def _decompose_system(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Torsten Hoefler decomposes into agents"""
        return (
    ...
    def _design_topology(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Torsten Hoefler designs communication topology"""
        return (
    ...
    def _assign_roles(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Torsten Hoefler assigns agent roles"""
        return (
    ...
    def _handle_failures(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Torsten Hoefler handles agent failures"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Torsten Hoefler skeptical"""
        return (
    ...
    def _recommend(self, task: str, context: Dict[str, Any] = None) -> str:
        """What Torsten Hoefler recommends"""
        return (
