# src/twins/cognitive_models/joão_moura.py
"""
Cognitive Twin: João Moura
...
of João Moura — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-JOÃO-MOURA",
    paper="Cognitive Twin Schema: João Moura",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like João Moura, not just cite their papers",
    confidence="HIGH",
)
class JoãoMouraTwin:
    """
    Cognitive Twin of João Moura.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as João Moura would think about this task.
    ...
    def _decompose_system(self, task: str, context: Dict[str, Any] = None) -> str:
        """How João Moura decomposes into agents"""
        return (
    ...
    def _design_topology(self, task: str, context: Dict[str, Any] = None) -> str:
        """How João Moura designs communication topology"""
        return (
    ...
    def _assign_roles(self, task: str, context: Dict[str, Any] = None) -> str:
        """How João Moura assigns agent roles"""
        return (
    ...
    def _handle_failures(self, task: str, context: Dict[str, Any] = None) -> str:
        """How João Moura handles agent failures"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes João Moura skeptical"""
        return (
