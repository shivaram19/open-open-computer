# src/twins/cognitive_models/shunyu_yao.py
"""
Cognitive Twin: Shunyu Yao
...
of Shunyu Yao — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-SHUNYU-YAO",
    paper="Cognitive Twin Schema: Shunyu Yao",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Shunyu Yao, not just cite their papers",
    confidence="HIGH",
)
class ShunyuYaoTwin(CognitiveTwin):
    """
    Cognitive Twin of Shunyu Yao.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Shunyu Yao would think about this task.
    ...
    def _initial_attempt(self, task: str, context: Dict[str, Any] = None) -> str:
        """Shunyu Yao's first quick attempt"""
        return (
    ...
    def _self_critique(self, task: str, context: Dict[str, Any] = None) -> str:
        """Shunyu Yao's critique of their own reasoning"""
        return (
    ...
    def _feedback_loop(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Shunyu Yao uses feedback for refinement"""
        return (
    ...
    def _iterative_refinement(self, task: str, context: Dict[str, Any] = None) -> str:
        """Shunyu Yao's iteration strategy"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Shunyu Yao skeptical"""
        return (
