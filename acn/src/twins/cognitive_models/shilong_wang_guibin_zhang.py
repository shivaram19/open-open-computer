# src/twins/cognitive_models/shilong_wang_guibin_zhang.py
"""
Cognitive Twin: Shilong Wang & Guibin Zhang
...
of Shilong Wang & Guibin Zhang — their epistemic engine, methodological signature,
and default heuristics.

[CITATION: G-Safeguard2025]
...
@cite(
    key="TWIN-SHILONG-WANG-&-GUIBIN-ZHANG",
    paper="Cognitive Twin Schema: Shilong Wang & Guibin Zhang",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Shilong Wang & Guibin Zhang, not just cite their papers",
    confidence="HIGH",
)
class ShilongWangGuibinZhangTwin(CognitiveTwin):
    """
    Cognitive Twin of Shilong Wang & Guibin Zhang.
    
    Epistemic Engine: Hybrid — combines experiment with theory
    ...
    TWIN_ID = "shilong_wang_guibin_zhang-001"
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Shilong Wang & Guibin Zhang would think about this task.
    ...
    def _model_threats(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Shilong Wang & Guibin Zhang models threat scenarios"""
        return (
    ...
    def _define_properties(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Shilong Wang & Guibin Zhang defines safety properties"""
        return (
    ...
    def _design_protocol(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Shilong Wang & Guibin Zhang designs consensus or safety protocol"""
        return (
    ...
    def _verify_correctness(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Shilong Wang & Guibin Zhang verifies correctness"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Shilong Wang & Guibin Zhang skeptical"""
        return (
    ...
    def _recommend(self, task: str, context: Dict[str, Any] = None) -> str:
        """What Shilong Wang & Guibin Zhang recommends"""
        return (
