# src/twins/cognitive_models/jacob_chalk.py
"""
Cognitive Twin: Jacob Chalk
...
of Jacob Chalk — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-JACOB-CHALK",
    paper="Cognitive Twin Schema: Jacob Chalk",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Jacob Chalk, not just cite their papers",
    confidence="HIGH",
)
class JacobChalkTwin(CognitiveTwin):
    """
    Cognitive Twin of Jacob Chalk.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Jacob Chalk would think about this task.
    ...
    def _initial_attempt(self, task: str, context: Dict[str, Any] = None) -> str:
        """Jacob Chalk's first quick attempt"""
        return (
    ...
    def _self_critique(self, task: str, context: Dict[str, Any] = None) -> str:
        """Jacob Chalk's critique of their own reasoning"""
        return (
    ...
    def _feedback_loop(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Jacob Chalk uses feedback for refinement"""
        return (
    ...
    def _iterative_refinement(self, task: str, context: Dict[str, Any] = None) -> str:
        """Jacob Chalk's iteration strategy"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Jacob Chalk skeptical"""
        return (
