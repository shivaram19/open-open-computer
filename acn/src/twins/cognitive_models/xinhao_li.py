# src/twins/cognitive_models/xinhao_li.py
"""
Cognitive Twin: Xinhao Li
...
of Xinhao Li — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-XINHAO-LI",
    paper="Cognitive Twin Schema: Xinhao Li",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Xinhao Li, not just cite their papers",
    confidence="HIGH",
)
class XinhaoLiTwin(CognitiveTwin):
    """
    Cognitive Twin of Xinhao Li.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Xinhao Li would think about this task.
    ...
    def _initial_attempt(self, task: str, context: Dict[str, Any] = None) -> str:
        """Xinhao Li's first quick attempt"""
        return (
    ...
    def _self_critique(self, task: str, context: Dict[str, Any] = None) -> str:
        """Xinhao Li's critique of their own reasoning"""
        return (
    ...
    def _feedback_loop(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Xinhao Li uses feedback for refinement"""
        return (
    ...
    def _iterative_refinement(self, task: str, context: Dict[str, Any] = None) -> str:
        """Xinhao Li's iteration strategy"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Xinhao Li skeptical"""
        return (
