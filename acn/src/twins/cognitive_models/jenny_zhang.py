# src/twins/cognitive_models/jenny_zhang.py
"""
Cognitive Twin: Jenny Zhang
...
of Jenny Zhang — their epistemic engine, methodological signature,
...
@cite(
    key="TWIN-JENNY-ZHANG",
    paper="Cognitive Twin Schema: Jenny Zhang",
    venue="ACN Harness Architecture",
    section="Cognitive Twin Models",
    rationale="Twin must think like Jenny Zhang, not just cite their papers",
    confidence="HIGH",
)
class JennyZhangTwin(CognitiveTwin):
    """
    Cognitive Twin of Jenny Zhang.
    ...
    def think(self, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Generate a reasoning trace as Jenny Zhang would think about this task.
    ...
    def _initial_attempt(self, task: str, context: Dict[str, Any] = None) -> str:
        """Jenny Zhang's first quick attempt"""
        return (
    ...
    def _self_critique(self, task: str, context: Dict[str, Any] = None) -> str:
        """Jenny Zhang's critique of their own reasoning"""
        return (
    ...
    def _feedback_loop(self, task: str, context: Dict[str, Any] = None) -> str:
        """How Jenny Zhang uses feedback for refinement"""
        return (
    ...
    def _iterative_refinement(self, task: str, context: Dict[str, Any] = None) -> str:
        """Jenny Zhang's iteration strategy"""
        return (
    ...
    def _express_skepticism(self, task: str, context: Dict[str, Any] = None) -> str:
        """What makes Jenny Zhang skeptical"""
        return (
